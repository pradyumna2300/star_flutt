...
class MyVisitlistBill extends StatefulWidget {
  const MyVisitlistBill({super.key});

  @override
  State<MyVisitlistBill> createState() => _MyVisitlistBillState();
}

class _MyVisitlistBillState extends State<MyVisitlistBill> {
                ...
                Row(
                  ...
                  children: [
                      ...
                      InkWell(
                        onTap: (){
                           Navigator.push(
            context, MaterialPageRoute(builder: (context) => MyBillList()));
                        },//prescription
                        child: Container(
                          width:190,
