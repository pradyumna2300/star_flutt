...
class MyVisitlistAdmission extends StatefulWidget {
  const MyVisitlistAdmission({super.key});

  @override
  State<MyVisitlistAdmission> createState() => _MyVisitlistAdmissionState();
}

class _MyVisitlistAdmissionState extends State<MyVisitlistAdmission> {
  List<Admissionlist>? apiList;
  @override
  void initState() {
                ...
                Row(
                  ...
                  children: [
                      ...
                      InkWell(
                        onTap: (){
                           Navigator.push(
            context, MaterialPageRoute(builder: (context) => MyAdmission()));
                        },//prescription
                        child: Container(
                          width:190,
  ...
  Future<void> getApiData() async{
    ...
    print(result.body);
    apiList=jsonDecode(result.body).map((item) => Admissionlist.fromJson(item)).toList().cast<Admissionlist>();
  }
}