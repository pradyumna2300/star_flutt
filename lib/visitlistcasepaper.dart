...
import 'package:star_flutt/casepaperlist.dart';
...
class MyVisitListCasePaper extends StatefulWidget {
  const MyVisitListCasePaper({super.key});

  @override
  State<MyVisitListCasePaper> createState() => _MyVisitListCasePaperState();
}

class _MyVisitListCasePaperState extends State<MyVisitListCasePaper> {
                ...
                Row(
                  ...
                  children: [
                      ...
                      InkWell(
                        onTap: (){
                           Navigator.push(
            context, MaterialPageRoute(builder: (context) => MyCasePaperList()));
                        },//prescription
                        child: Container(
                          width:150,
