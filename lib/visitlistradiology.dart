...
List<Visitmodel> visitmodelFromJson(String str) =>
    List<Visitmodel>.from(json.decode(str).map((x) => Visitmodel.fromJson(x)));

String visitmodelToJson(List<Visitmodel> data) =>
...
class MyVisitListRadiology extends StatefulWidget {
  const MyVisitListRadiology({super.key});

  @override
  State<MyVisitListRadiology> createState() => _MyVisitListRadiologyState();
}

class _MyVisitListRadiologyState extends State<MyVisitListRadiology> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Radiology"),backgroundColor: Color.fromARGB(
                                                255, 5, 117, 134),),
      body: isLoading
          ? const Center(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  ListTile(
                                    title: Text(
                                      "Dr." +
                                          '${apiList![index].doctorName}', //apiList![index].updatedDateTime
                                      style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                      ),
                                    ),
                                    subtitle: Text('VisitId: ' +
                                        '${apiList![index].visitId}'),
  ...
  Future<void> getApiData() async {
    String url = "http://mobileapis.clinosys.com/api/Visits?regNo=311";
